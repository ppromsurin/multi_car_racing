    ...
    def step(self, action):
        ...
        if True:
            ...
            #https://www.nagwa.com/en/explainers/939127418581/#:~:text=The%20perpendicular%20distance%20between%20a%20point%20and%20a%20line%20is,any%20point%20on%20the%20line.
                ...
                future_track_idx = np.array(np.arange(track_index, track_index+10) % len(self.track), dtype=int)
                # print(future_track_idx)
                # print(type(future_track_idx))
                fucknumpy = np.asarray(self.track, dtype=object) # I fucking hate numpy
                # print(type(self.track))
                # print(fucknumpy.shape)
                # print(fucknumpy[future_track_idx])
                future_angles = fucknumpy[future_track_idx,1]
